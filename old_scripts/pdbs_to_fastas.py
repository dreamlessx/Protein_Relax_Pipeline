...
PDB_ID_RE = re.compile(r"([0-9][A-Za-z0-9]{3})")  # first 4-char PDB id starting with a digit
...
def main():
    if len(sys.argv) < 2 or len(sys.argv) > 4:
        print("Usage: python3 pdbs_to_fastas.py <merged_dir> [fasta_out_dir] [--overwrite]")
        sys.exit(1)
